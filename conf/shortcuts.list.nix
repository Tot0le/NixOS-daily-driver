...

{
  ...
  fans = {
    fanMinus2   = [ "Fan -2%" "fan_control.sh minus 2" "<Super><Ctrl>code:10" ];
    fanPlus2    = [ "Fan +2%" "fan_control.sh plus 2" "<Super><Ctrl>code:11" ];
    fanMinus10  = [ "Fan -10%" "fan_control.sh minus 10" "<Super><Ctrl>code:12" ];
    fanPlus10   = [ "Fan +10%" "fan_control.sh plus 10" "<Super><Ctrl>code:13" ];
    fanSet50    = [ "Fan 50%" "fan_control.sh set 50" "<Super><Ctrl>code:14" ];
    fanSet80    = [ "Fan 80%" "fan_control.sh set 80" "<Super><Ctrl>code:15" ];
    fanSet100   = [ "Fan 100%" "fan_control.sh set 100" "<Super><Ctrl>code:16" ];
    fanAuto     = [ "Fan Auto" "fan_control.sh auto" "<Super><Ctrl>code:17" ];
  };
